...
**When to use:** at the start of the redesign, or when re-planning the remaining scope (Work 05, Contact 06, ember re-theme, v2 motion upgrades) — chapters 00–04 are already built; plan around them, don't re-plan them.
